...
function renderInventory(data) {
  ...
  data.forEach(item => {
    ...
    div.className = "item";
    div.innerHTML = `
      <img src="http://ajvplpbxsrxgdldcosdf.supabase.co/storage/v1/object/public/${item.image_path}"  onclick="placeOrder('${item.isbn}')" onerror="this.src='http://ajvplpbxsrxgdldcosdf.supabase.co/storage/v1/object/public/image/book/cover.jpg';" />
