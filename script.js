...
function renderInventory(data) {
  ...
  data.forEach(item => {
    ...
    div.className = "item";
    div.innerHTML = `
      <img src="https://ajvplpbxsrxgdldcosdf.supabase.co/storage/v1/object/public/image/book/${item.image_path}" onerror="this.src='https://ajvplpbxsrxgdldcosdf.supabase.co/storage/v1/object/public/image/book/cover.jpg';" />
